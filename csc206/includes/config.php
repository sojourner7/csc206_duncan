...
/*if (! defined('DB_USER')) define('DB_USER', 'asdf');
if (! defined('DB_PASS')) define('DB_PASS', 'mypassword');
...
if (! defined('FS_INCLUDES')) define('FS_INCLUDES',  FS_ROOT.'/csc206/includes/');
if (! defined('FS_TEMPLATES')) define('FS_TEMPLATES', FS_ROOT . '/csc206/templates/');
